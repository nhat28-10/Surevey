...
import type { AvailableCampaign, Campaign, CampaignPayment, Participation, Submission } from "./types";
...
export const campaignApi = {
  ...
  submissions: (id: number) => apiRequest<Submission[]>(`/survey/api/campaigns/${id}/submissions`),
